            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active"><a href="supplier.php"><i class="fa fa-id-card-o"></i>     <span>Supplier      </span></a></li>
                        <li class="inactive"><a href="category.php"><i class="fa fa-list"></i>        <span>Category      </span></a></li>
                        <li class="inactive"><a href="model.php"><i class="fa fa-cube"></i>           <span>Product       </span></a></li>
                        <li class="inactive"><a href="product.php"><i class="fa fa-cubes"></i>        <span>Stock Count   </span></a></li>
                        ...
                        <form role="form">
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="" placeholder="Phone" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <thead>
                            <tr>
                              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Supplier ID</th>
