            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                      ...
                      <tbody>
                        ...
                        $query = "SELECT * FROM categories_sub ORDER BY created_at desc";
                        if($result = mysqli_query($link, $query)){
                          if(mysqli_num_rows($result) > 0){
                            ...
                            while($row = mysqli_fetch_array($result)){
                              ...
                              <td>
                              <a href='category-sub-update.php?id=<?php echo $row['id'] ?>' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <a class="btn btn-danger" href='category-sub-delete.php?id=<?php echo $row['id'] ?>&scat=<?php echo $row['sub_category_name'];?>&pcat=<?php echo $row['parent_category'];?>'>Delete</a>
                                    </div>
                                  </div>
                                  <!-- /.modal-content -->
                                </div>
