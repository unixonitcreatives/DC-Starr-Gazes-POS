  ...
  <section class="content">
          ...
          <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title">Expired Stocks Data</h3><br>
              ...
              <div class="box-body">
                ...
                if(!empty($start) && !empty($end)){
                  ...
                  //   WHERE sales_order.created_at BETWEEN '$start' AND '$end'";
                    ...
                    $query = "SELECT * from expired_stocks
                       WHERE stock_status='Expired' AND expiry_date BETWEEN '$start' AND '$end'";
                }
